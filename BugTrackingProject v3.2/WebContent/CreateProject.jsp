...
<table>
  ...
  <tr><td>Start date : </td><td><input type="date" name="startDate" id="dt" min="2020-09-05"  value="<%=sdf.format(dNow) %>" required placeholder="yyyy-mm-dd"></td><td></td></tr>
  <tr><td>Description :</td><td><textarea rows="3" cols="20" name="description" id="desc"></textarea></td></tr>
  <%List<User> ulist=(ArrayList<User>)request.getAttribute("ulist");%></table>
<table border="2"><br>
